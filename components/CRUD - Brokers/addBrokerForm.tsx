      ...
      <>
            ...
            <div className="fixed z-20 inset-0 flex items-center justify-center">
              <div className="relative bg-white rounded-md shadow-lg max-w-lg w-full">
                <button  className="absolute top-2 right-2  hover:bg-zinc-200 text-black rounded-full w-8 h-8 flex items-center justify-center" onClick={handler}><AiFillCloseCircle size={30}></AiFillCloseCircle></button>
                ...
                <div className="p-4">
                    <form className="grid lg:grid-cols-2 w-full gap-4 pl-3 "onSubmit={handleSubmit}>
                      ...
                      <Button  className="text-white border rounded-md hover:bg-green-50 hover:border-green-500 hover:text-green-500 text-xl col-span-2" type="submit" variant="solid"color="success"size="lg">
