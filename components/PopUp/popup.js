    ...
    <div style={styles.popupBackground} onClick={onClose}>
      ...
      >
        ...
        <button class="btn btn-primary" type="submit">Submit form</button>
             ...
             <label for="exampleFormControlInput1" class="form-label">Please put in your email address and a broker will contact you</label>
            </div>
...
const App = () => {
  ...
  return (
    <div>
      ...
      <FullscreenPopup isOpen={isPopupOpen} onClose={() => setPopupOpen(false)} />
    </div>
  );
};
